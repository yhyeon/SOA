...
Invoke-MySqlQuery -Query "truncate archive_arc;"
 Invoke-MySqlQuery -Query "truncate archive_src;"
...
if($result1.datetime -eq $result.datetime -and $result1.file -eq $result.file)
{
    ...
    $src_outfile = $result1.DiskSN + ":::;"+ $result1.IP + ":::;"+ $result1.MAC + ":::;"+ $result1.cname + ":::;"+ $result1.uname + ":::;"+ $result1.datetime + ":::;"+ $result1.root + ":::;"+ $result1.directory + ":::;"+ $result1.file + ":::;"+ $result1.ext + ":::;"
   
   $src_outfile | Out-File "C:\backlog\filter\archive_src.txt" -Append -Encoding utf8
$squery = "load data local infile" + " " + "'" + "C:\backlog\filter\archive_src.txt".replace("\","\\") + "'" + " " + "into table soa_log.archive_src fields terminated by ':::;' lines terminated by '\n' (DiskSN,IP,MAC,Cname,Uname,datetime,root,directory,file,ext,curs);"
Invoke-MySqlQuery -Query $squery
Invoke-MySqlQuery -query "select * from soa_log.archive_src order by id desc limit 1;"
Remove-Item "C:\backlog\filter\archive_src.txt" -Force
