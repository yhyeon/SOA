...
$IP + ":::;" + $MAC + ":::;" + $log + ":::;" + $eventid + ":::;" + $date + ":::;" + $time + ":::;" + $computer + ":::;" + $subjectsid + ":::;" + $subjectuname + ":::;" + $subjectdname + ":::;" + $subjectlogonid + ":::;" + ":::;" + $targetuname + ":::;" + $targetdname + ":::;" + ":::;" | out-file C:\Users\Public\Documents\${MAC}_$(get-date -f yyyyMMddHH)_logonoff.txt -Append -encoding utf8
}
...
$IP + ":::;" + $MAC + ":::;" + $log + ":::;" + $eventid + ":::;" + $date + ":::;" + $time + ":::;" + $computer + ":::;" +  ":::;" +  ":::;" +  ":::;" +  ":::;" + $targetsid + ":::;" + $targetuname + ":::;" + $targetdname + ":::;" + $targetlogonid+ ":::;" | out-file C:\Users\Public\Documents\${MAC}_$(get-date -f yyyyMMddHH)_logonoff.txt -Append -encoding utf8
}
...
$targetdname = $logon | select-string -Pattern 'TargetDomainName'
$targetdname = $targetdname.line.Split(">")[1]
$IP + ":::;" + $MAC + ":::;" + $log + ":::;" + $eventid + ":::;" + $date + ":::;" + $time + ":::;" + $computer + ":::;" + ":::;" + ":::;" + ":::;" + ":::;" + $targetsid + ":::;" + $targetuname + ":::;" + $targetdname + ":::;" + ":::;" | out-file C:\Users\Public\Documents\${MAC}_$(get-date -f yyyyMMddHH)_logonoff.txt -Append -encoding utf8
}
...
$targetdname = $logon | select-string -Pattern 'TargetDomainName'
$targetdname = $targetdname.line.Split(">")[1]
$IP + ":::;" + $MAC + ":::;" + $log + ":::;" + $eventid + ":::;" + $date + ":::;" + $time + ":::;" + $computer + ":::;" + ":::;" + ":::;" +  ":::;" +  ":::;" + ":::;" +  ":::;" +  ":::;" + ":::;" | out-file C:\Users\Public\Documents\${MAC}_$(get-date -f yyyyMMddHH)_logonoff.txt -Append -encoding utf8
}
...
$IP + ":::;" + $MAC + ":::;" + $log + ":::;" + $eventid + ":::;" + $date + ":::;" + $time + ":::;" + $computer + ":::;" + $subjectsid + ":::;" + $subjectuname + ":::;" + $subjectdname + ":::;" + $subjectlogonid + ":::;" + $targetsid + ":::;" + $targetuname + ":::;" + $targetdname + ":::;" + ":::;" + $failuecode | out-file C:\Users\Public\Documents\${MAC}_$(get-date -f yyyyMMddHH)_logonoff.txt -Append -encoding utf8
}
...
$IP + ":::;" + $MAC + ":::;" + $log + ":::;" + $eventid + ":::;" + $date + ":::;" + $time + ":::;" + $computer + ":::;" + $subjectsid + ":::;" + $subjectuname + ":::;" + $subjectdname + ":::;" + $subjectlogonid + ":::;" + $targetsid + ":::;" + $targetuname + ":::;" + $targetdname + ":::;" + ":::;" + $failuecode  | out-file C:\Users\Public\Documents\${env:COMPUTERNAME}_$(get-date -f yyyyMMddHH)_logonoff.txt -Append -encoding utf8
}
...
$IP + ":::;" + $MAC + ":::;" + $log + ":::;" + $eventid + ":::;" + $date + ":::;" + $time + ":::;" + $time + ":::;" + $computer + ":::;" + $subjectsid + ":::;" + $subjectuname + ":::;" + $subjectdname + ":::;" + $subjectlogonid + ":::;" + $targetsid + ":::;" + $targetuname + ":::;" + $targetdname + ":::;" + ":::;" + $failuecode | out-file C:\Users\Public\Documents\${MAC}_$(get-date -f yyyyMMddHH)_logonoff.txt -Append -encoding utf8
}
