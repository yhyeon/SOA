...
foreach {
$dst = "http://192.168.1.50/transfer/$($_.basename)" # server directory with write permissions
Start-BitsTransfer -source $($_.FullName) -Destination $dst -Credential $cred -TransferType Upload
}