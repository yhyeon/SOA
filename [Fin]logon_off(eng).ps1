...
$log + " : " + $eventid + " : " + $time + " : " + $computer + " : " + $subjectsid + " : " + $subjectuname + " : " + $subjectdname + " : " + $subjectlogonid + " : " + " : " + $targetuname + " : " + $targetdname + " : " + " : "   | out-file C:\Users\Public\Documents\${env:COMPUTERNAME}_$(get-date -f yyyyMMddhh)_logonoff.txt -Append
}
...
$log + " : " + $eventid + " : " + $time + " : " + $computer + " : " +  " : " +  " : " +  " : " +  " : " + $targetsid + " : " + $targetuname + " : " + $targetdname + " : " + $targetlogonid+ " : "  | out-file C:\Users\Public\Documents\${env:COMPUTERNAME}_$(get-date -f yyyyMMddhh)_logonoff.txt -Append
}
...
$targetdname = $logon | select-string -Pattern 'TargetDomainName'
$targetdname = $targetdname.line.Split(">")[1]
$log + " : " + $eventid + " : " + $time + " : " + $computer + " : " + " : " + " : " + " : " + " : " + $targetsid + " : " + $targetuname + " : " + $targetdname + " : " + " : "  | out-file C:\Users\Public\Documents\${env:COMPUTERNAME}_$(get-date -f yyyyMMddhh)_logonoff.txt -Append
}
...
$targetdname = $logon | select-string -Pattern 'TargetDomainName'
$targetdname = $targetdname.line.Split(">")[1]
$log + " : " + $eventid + " : " + $time + " : " + $computer + " : " + " : " + " : " +  " : " +  " : " + " : " +  " : " +  " : " + " : "  | out-file C:\Users\Public\Documents\${env:COMPUTERNAME}_$(get-date -f yyyyMMddhh)_logonoff.txt -Append
}
...
$log + " : " + $eventid + " : " + $time + " : " + $computer + " : " + $subjectsid + " : " + $subjectuname + " : " + $subjectdname + " : " + $subjectlogonid + " : " + $targetsid + " : " + $targetuname + " : " + $targetdname + " : " + " : " + $failuecode  | out-file C:\Users\Public\Documents\${env:COMPUTERNAME}_$(get-date -f yyyyMMddhh)_logonoff.txt -Append
}
